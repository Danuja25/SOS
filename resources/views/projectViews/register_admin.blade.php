...
<!-- registration -->
<form class="main-1" action="{{route('registerAdmin')}}" method="POST">
    <div class="container">
        <div class="register">
            <div class="register-top-grid">
                ...
                <div class="wow fadeInLeft" data-wow-delay="0.4s">
                    ...
                    <input type="text" name="name" required value="{{old('name')}}">        {{--Getting information from the user and keeping the previously entered value for ease of use--}}
                </div>
                <div class="wow fadeInLeft" data-wow-delay="0.4s">
                ...
                <a class="news-letter" href="#">
                    ...
                    <i> </i>I certify that these details are correct
                </a>
            </div>
